...
class TimeEntry extends Model
{
    ...
    {
        return $this->belongsTo(ProjectSubtask::class, 'project_subtask_id');
    }
    ...
    {
        // Subtask heeft hoogste prioriteit (meest specifiek)
        if ($this->subtask) {
            return $this->subtask->name;
        }
