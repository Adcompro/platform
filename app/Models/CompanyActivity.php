...
class CompanyActivity extends Model
{
    ...
    public function getIconAttribute(): string
    {
        return match($this->action) {
            ...
            'bank_details_updated' => 'fas fa-university text-purple-500',
            'invoice_settings_updated' => 'fas fa-file-invoice text-indigo-500',
            'vat_updated' => 'fas fa-percent text-orange-500',
    ...
    public function getBadgeColorAttribute(): string
    {
        return match($this->action) {
            ...
            'bank_details_updated' => 'bg-purple-100 text-purple-800',
            'invoice_settings_updated' => 'bg-indigo-100 text-indigo-800',
            'vat_updated' => 'bg-orange-100 text-orange-800',
     ...
     */
    public static function log($companyId, $action, $description, $changes = null)
    {
        return self::create([
