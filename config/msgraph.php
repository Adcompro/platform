...
return [
    ...
    */
    'redirectUri' => env('MSGRAPH_REDIRECT_URI', 'https://progress.adcompro.app/msgraph/oauth'),
    ...
    */
    ...
    'scopes' => 'offline_access openid User.Read Calendars.Read Calendars.ReadWrite',

    /*
    The default timezone is set to Europe/London this option allows you to set your prefered timetime
    */
    'preferTimezone' => env('MSGRAPH_PREFER_TIMEZONE', 'outlook.timezone="Europe/Amsterdam"'),
