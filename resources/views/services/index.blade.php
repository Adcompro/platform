    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
            ...
            <div class="bg-slate-50 border border-slate-200/50 rounded-xl p-3 hover:shadow-md transition-all">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p style="font-size: calc(var(--theme-font-size) - 2px); font-weight: 500; color: var(--theme-text-muted);">Categories</p>
                        <p style="font-size: 1.125rem; font-weight: 600; color: var(--theme-text);">{{ $stats['total_categories'] }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            <form method="GET" action="{{ route('services.index') }}" class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                ...
                @if(Auth::user()->role === 'super_admin' || (Auth::user()->role === 'admin' && count($categories) > 0))
                    ...
                    <div class="px-4 py-3 border-b border-slate-200/50 bg-gradient-to-r from-{{ $service->color ?? 'slate' }}-50 to-white">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                ...
                                @if($service->category)
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-lg mt-1"
                                          style="font-size: calc(var(--theme-font-size) - 2px); font-weight: 500;" 
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p style="font-size: var(--theme-font-size); color: var(--theme-text-muted);">Click "Create Service" to define a new service package with name, description, pricing, and category.</p>
                        </div>
                ...
                {{-- Categories Section --}}
                <div class="mb-6">
                    <h4 style="font-size: 1.125rem; font-weight: 600; color: var(--theme-text); margin-bottom: 0.75rem;">Service Categories</h4>
                    <p style="font-size: var(--theme-font-size); color: var(--theme-text-muted); margin-bottom: 0.5rem;">
                        Organize your services using categories for better management:
                    </p>
                    <ul style="list-style-type: disc; list-style-position: inside; font-size: var(--theme-font-size); color: var(--theme-text-muted);" class="space-y-1">
                        <li>Create custom categories with colors and icons</li>
                        <li>Filter services by category in the overview</li>
                        <li>Visual identification with category badges</li>
                        <li>Manage categories from the "Package Categories" button</li>
                    </ul>
                </div>
