                    ...
                    <div class="rounded-lg shadow-sm" style="background: var(--theme-surface); border: 1px solid rgba(var(--theme-border-rgb), 0.3);">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="category" class="block text-sm font-medium" style="color: var(--theme-text);">Category</label>
...
<template id="milestone-template">
    <div class="milestone-item rounded-lg p-6" data-milestone-index="" style="padding: 1.5rem; background: rgba(var(--theme-primary-rgb), 0.05); border: 1px solid rgba(var(--theme-primary-rgb), 0.3);">
        ...
        <div class="mb-4">
            ...
            <textarea name="milestones[0][description]" rows="2"
                      class="mt-1 block w-full rounded-md shadow-sm" 
                      style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                      onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                      onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'"></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">Hourly Rate (€)</label>
                <input type="number" name="milestones[0][hourly_rate]" step="0.01" min="0"
                       class="mt-1 block w-full rounded-md shadow-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
            ...
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">Start Day</label>
                <input type="number" name="milestones[0][days_from_start]" min="0"
                       class="mt-1 block w-full rounded-md shadow-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
            ...
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">Duration (days)</label>
                <input type="number" name="milestones[0][duration_days]" min="0"
                       class="mt-1 block w-full rounded-md shadow-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">Start Date</label>
                <input type="date" name="milestones[0][start_date]"
                       class="mt-1 block w-full rounded-md shadow-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
        ...
        <div class="mb-4">
            <label class="block text-sm font-medium" style="color: var(--theme-text);">End Date</label>
            <input type="date" name="milestones[0][end_date]"
                   class="mt-1 block w-full rounded-md shadow-sm" 
                   style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                   onfocus="this.style.borderColor='var(--theme-primary)'; this.style.boxShadow='0 0 0 1px var(--theme-primary)'"
                   onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
...
<template id="task-template">
    <div class="task-item rounded p-4" data-task-index="" style="padding: 1rem; background: rgba(var(--theme-accent-rgb), 0.05); border: 1px solid rgba(var(--theme-accent-rgb), 0.3);">
        ...
        <div class="mb-3">
            <label class="block text-sm font-medium" style="color: var(--theme-text);">Beschrijving</label>
            <textarea name="milestones[0][tasks][0][description]" rows="2"
                      class="mt-1 block w-full rounded-md shadow-sm text-sm" 
                      style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                      onfocus="this.style.borderColor='var(--theme-accent)'; this.style.boxShadow='0 0 0 1px var(--theme-accent)'"
                      onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'"></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            ...
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">Start Date</label>
                <input type="date" name="milestones[0][tasks][0][start_date]"
                       class="mt-1 block w-full rounded-md shadow-sm text-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-accent)'; this.style.boxShadow='0 0 0 1px var(--theme-accent)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
            ...
            <div>
                <label class="block text-sm font-medium" style="color: var(--theme-text);">End Date</label>
                <input type="date" name="milestones[0][tasks][0][end_date]"
                       class="mt-1 block w-full rounded-md shadow-sm text-sm" 
                       style="background: var(--theme-input-bg); border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);"
                       onfocus="this.style.borderColor='var(--theme-accent)'; this.style.boxShadow='0 0 0 1px var(--theme-accent)'"
                       onblur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='none'">
