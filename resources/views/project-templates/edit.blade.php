                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-xl mb-8" style="border: 1px solid rgba(var(--theme-border-rgb), 0.3); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                        ...
                        <div class="p-6 space-y-6" style="padding: 1.5rem;">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="category" class="block font-medium" style="color: var(--theme-text); ">Categorie</label>
                                    <select name="category" id="category" 
                                        ...
                                        <option value="website" {{ old('category', $projectTemplate->category) === 'website' ? 'selected' : '' }}>Website Development</option>
                                        <option value="app" {{ old('category', $projectTemplate->category) === 'app' ? 'selected' : '' }}>App Development</option>
                                        <option value="marketing" {{ old('category', $projectTemplate->category) === 'marketing' ? 'selected' : '' }}>Marketing Campaign</option>
                                        <option value="consultancy" {{ old('category', $projectTemplate->category) === 'consultancy' ? 'selected' : '' }}>Consultancy</option>
                                        <option value="design" {{ old('category', $projectTemplate->category) === 'design' ? 'selected' : '' }}>Design Project</option>
                                        <option value="other" {{ old('category', $projectTemplate->category) === 'other' ? 'selected' : '' }}>Overig</option>
                                    </select>
                                    @error('category')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                @foreach($projectTemplate->milestones as $milestone)
                                    <div class="milestone-item rounded-lg p-6" data-milestone-index="{{ $loop->iteration }}" data-milestone-id="milestone-{{ $milestone->id }}" 
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="milestones[{{ $loop->index }}][description]" rows="2"
                                                      class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                      style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                      onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                                                      onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                            ...
                                            <div>
                                                <label class="block font-medium" style="color: var(--theme-text); ">Hourly Rate (€)</label>
                                                <input type="number" name="milestones[{{ $loop->index }}][hourly_rate]" step="0.01" min="0"
                                                       value="{{ $milestone->default_hourly_rate }}"
                                                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                                                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
                                            ...
                                            <div>
                                                <label class="block font-medium" style="color: var(--theme-text); ">Start Date</label>
                                                <input type="date" name="milestones[{{ $loop->index }}][start_date]"
                                                       value="{{ $milestone->start_date ? $milestone->start_date->format('Y-m-d') : '' }}"
                                                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                                                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
                                            ...
                                            <div>
                                                <label class="block font-medium" style="color: var(--theme-text); ">End Date</label>
                                                <input type="date" name="milestones[{{ $loop->index }}][end_date]"
                                                       value="{{ $milestone->end_date ? $milestone->end_date->format('Y-m-d') : '' }}"
                                                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                                                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
                                                ...
                                                @foreach($milestone->tasks as $task)
                                                    <div class="task-item rounded p-4" data-task-index="{{ $loop->iteration }}" data-task-id="task-{{ $milestone->id }}-{{ $task->id }}" 
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                                                            ...
                                                            <div>
                                                                <label class="block font-medium" style="color: var(--theme-text); ">Hourly Rate (€)</label>
                                                                <input type="number" name="milestones[{{ $milestone->sort_order - 1 }}][tasks][{{ $loop->index }}][hourly_rate]" step="0.01" min="0"
                                                                       value="{{ $task->hourly_rate ?? $task->default_hourly_rate }}"
                                                                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                                       onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                                                                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
                                                                       placeholder="Use milestone default">
                                                            </div>
                                                            <div>
                                                                <label class="block font-medium" style="color: var(--theme-text); ">Estimated Hours</label>
                                                        ...
                                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                                                            ...
                                                            <div>
                                                                <label class="block font-medium" style="color: var(--theme-text); ">Start Date</label>
                                                                <input type="date" name="milestones[{{ $milestone->sort_order - 1 }}][tasks][{{ $loop->index }}][start_date]"
                                                            ...
                                                            <div>
                                                                <label class="block font-medium" style="color: var(--theme-text); ">End Date</label>
                                                                <input type="date" name="milestones[{{ $milestone->sort_order - 1 }}][tasks][{{ $loop->index }}][end_date]"
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="block font-medium" style="color: var(--theme-text); ">Description</label>
                                                            <textarea name="milestones[{{ $milestone->sort_order - 1 }}][tasks][{{ $loop->index }}][description]" rows="2"
                                                                      class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                                                                      style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                                                                      onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                                                                      onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
...
<template id="milestone-template">
    <div class="milestone-item rounded-lg p-6" data-milestone-index="" data-milestone-id="" 
        ...
        <div class="mb-4">
            <label class="block font-medium" style="color: var(--theme-text); ">Description</label>
            <textarea name="milestones[][description]" rows="2"
                      class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                      style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                      onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                      onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">Hourly Rate (€)</label>
                <input type="number" name="milestones[][hourly_rate]" step="0.01" min="0"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
            ...
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">Start Date</label>
                <input type="date" name="milestones[][start_date]"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
            ...
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">End Date</label>
                <input type="date" name="milestones[][end_date]"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-primary-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-primary-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
...
<template id="task-template">
    <div class="task-item rounded p-4" data-task-index="" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            ...
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">Hourly Rate (€)</label>
                <input type="number" name="milestones[][tasks][][hourly_rate]" step="0.01" min="0"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">Start Date</label>
                <input type="date" name="milestones[][tasks][][start_date]"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
            ...
            <div>
                <label class="block font-medium" style="color: var(--theme-text); ">End Date</label>
                <input type="date" name="milestones[][tasks][][end_date]"
                       class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                       style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                       onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                       onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';">
        ...
        <div class="mb-3">
            <label class="block font-medium" style="color: var(--theme-text); ">Description</label>
            <textarea name="milestones[][tasks][][description]" rows="2"
                      class="mt-1 block w-full rounded-md px-3 py-2 transition-colors"
                      style="background: white; border: 1px solid rgba(var(--theme-border-rgb), 0.3); color: var(--theme-text);  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);"
                      onFocus="this.style.borderColor='rgb(var(--theme-accent-rgb))'; this.style.boxShadow='0 0 0 3px rgba(var(--theme-accent-rgb), 0.1)';"
                      onBlur="this.style.borderColor='rgba(var(--theme-border-rgb), 0.3)'; this.style.boxShadow='0 1px 2px 0 rgba(0, 0, 0, 0.05)';"
