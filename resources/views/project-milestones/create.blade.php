        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-bold text-gray-900">Create New Milestone</h1>
                    <p class="text-sm text-gray-600">Add a new milestone to {{ $project->name }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="invoicing_trigger" id="invoicing_trigger" required
                            ...
                            <option value="completion" {{ old('invoicing_trigger', 'completion') == 'completion' ? 'selected' : '' }}>On Completion</option>
                            <option value="approval" {{ old('invoicing_trigger') == 'approval' ? 'selected' : '' }}>On Approval</option>
                            <option value="delivery" {{ old('invoicing_trigger') == 'delivery' ? 'selected' : '' }}>On Delivery</option>
                        </select>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deliverables" id="deliverables" rows="3"
                            ...
                            placeholder="List the expected deliverables for this milestone">{{ old('deliverables') }}</textarea>
                        @error('deliverables')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
