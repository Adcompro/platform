            ...
            <div class="lg:col-span-2 space-y-6">
                <div style="background: white; border: 1px solid rgba(203, 213, 225, 0.6); border-radius: var(--theme-border-radius); box-shadow: var(--theme-card-shadow);">
                    <div style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(203, 213, 225, 0.3);">
                        <h3 style="font-size: calc(var(--theme-font-size) + 2px); font-weight: 600; color: var(--theme-text);">Company Details</h3>
                    </div>
                    <div class="p-4">
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Company Name</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size); color: var(--theme-text);">{{ $company->name }}</dd>
                            </div>

                            @if($company->vat_number)
                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">VAT Number</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size); color: var(--theme-text);">{{ $company->vat_number }}</dd>
                            </div>
                            @endif

                            @if($company->email)
                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Email</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size);">
                                    <a href="mailto:{{ $company->email }}" class="primary-link" style="color: var(--theme-primary);">{{ $company->email }}</a>
                                </dd>
                            </div>
                            @endif
                            ...
                            @if($company->phone)
                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Phone</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size);">
                                    <a href="tel:{{ $company->phone }}" class="primary-link" style="color: var(--theme-primary);">{{ $company->phone }}</a>
                                </dd>
                            </div>
                            @endif
                            ...
                            @if($company->website)
                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Website</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size);">
                                    <a href="{{ $company->website }}" target="_blank" class="primary-link" style="color: var(--theme-primary);">{{ $company->website }}</a>
                                </dd>
                            </div>
                            @endif

                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Default Hourly Rate</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size); color: var(--theme-text);">€{{ number_format($company->default_hourly_rate ?? 0, 2) }}/hour</dd>
                            </div>

                            <div>
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Status</dt>
                                <dd class="mt-1">
                            ...
                            <div class="md:col-span-2">
                                <dt style="font-size: var(--theme-font-size); font-weight: normal; color: var(--theme-text-muted);">Address</dt>
                                <dd style="margin-top: 0.25rem; font-size: var(--theme-font-size); color: var(--theme-text);">
                                    ...
                                    @if($company->postal_code || $company->city)
                                        {{ $company->postal_code }}{{ $company->city ? ' ' . $company->city : '' }}<br>
                                    @endif
