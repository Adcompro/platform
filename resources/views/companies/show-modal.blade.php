...
<div>
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
            <dt style="font-size: calc(var(--theme-font-size) - 1px); font-weight: 500; color: var(--theme-text-muted); margin-bottom: 0.5rem;">VAT Number</dt>
            <dd style="font-size: var(--theme-font-size); color: var(--theme-text);">{{ $company->vat_number }}</dd>
        </div>
        @endif
        ...
        <div>
            <dt style="font-size: calc(var(--theme-font-size) - 1px); font-weight: 500; color: var(--theme-text-muted); margin-bottom: 0.5rem;">CoC Number</dt>
            <dd style="font-size: var(--theme-font-size); color: var(--theme-text);">{{ $company->registration_number }}</dd>
        </div>
        @endif
        ...
        <div>
            <dt style="font-size: calc(var(--theme-font-size) - 1px); font-weight: 500; color: var(--theme-text-muted); margin-bottom: 0.5rem;">Invoice Prefix</dt>
            <dd style="font-size: var(--theme-font-size); color: var(--theme-text); font-family: monospace;">{{ $company->invoice_prefix }}</dd>
        </div>
        @endif

        {{-- Next Invoice Number --}}
        <div>
            <dt style="font-size: calc(var(--theme-font-size) - 1px); font-weight: 500; color: var(--theme-text-muted); margin-bottom: 0.5rem;">Next Invoice</dt>
            <dd style="font-size: var(--theme-font-size); color: var(--theme-text); font-family: monospace;">{{ $company->invoice_prefix ?? '' }}{{ str_pad($company->next_invoice_number ?? 1, 4, '0', STR_PAD_LEFT) }}</dd>
        </div>
