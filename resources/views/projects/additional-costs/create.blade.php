...
@section('title', 'Add One-time Cost - ' . $project->name)
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Add One-time Cost</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <form action="{{ route('projects.additional-costs.store', $project) }}" method="POST">
                @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                               ...
                               placeholder="e.g., Domain Registration, SSL Certificate">
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                  placeholder="Detailed description of the cost">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <input type="hidden" name="cost_type" value="one_time">
                </div>
